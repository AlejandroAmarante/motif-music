// src/components/player/LyricsView.jsx
...
export function LyricsView({
	...
	const notFound =
		song?.lyrics === false ||
		(fetchState === "done" && song?.lyrics == null);
			...
			{isOpen && song && (
				...
				>
					...
					<div className="lyrics-view__body scroll-region">
						<p className="lyrics-view__heading">
							{song.title}
						</p>

						<p className="lyrics-view__subheading">
							{song.artist}
						</p>
						...
						{fetchState !== "loading" &&
							...
							(synced ? (
								...
								<p className="lyrics-view__plain">
									{song.lyrics?.text}
								</p>
							))}
					</div>
